<script lang="ts">
	import { Check, ListChecks, Plus, Trash2 } from '@lucide/svelte';
	import {
		conversationTasks,
...
<CompanionFrame title="Tasks" {onClose}>
	{#snippet icon()}
		<ListChecks class="size-4 shrink-0 text-muted-foreground" />
	{/snippet}

	<div class="flex min-h-0 flex-1 flex-col overflow-y-auto" data-testid="tasks-companion">
