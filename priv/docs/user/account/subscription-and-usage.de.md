...
Weil die Nutzung zum Selbstkostenpreis abgerechnet wird, bestimmst du selbst, wie viel du ausgeben kannst. Die Einstellungen findest du unter **Einstellungen → Abo → Spending controls** (sie setzen ein aktives Pay-as-you-go-Abo voraus).
...
Dein Plan bestimmt, wie viel Dateispeicher du hast und die maximale Grösse einzelner Uploads. Deine aktuelle Nutzung siehst du unter **Einstellungen → Speicher**.

Wenn dein Speicher knapp wird, kannst du:
- Dateien löschen, die du nicht mehr brauchst (siehe [Dateien & Speicher](../knowledge/files-and-storage.de.md))
- Pay-as-you-go abonnieren für höhere Speicherlimits

## Aktuelle Nutzung einsehen

1. Gehe zu **Einstellungen**
2. Öffne den Abschnitt **Abo**

Du siehst deinen Plan, was du in diesem Abrechnungszeitraum in CHF ausgegeben hast, dein Limit und die genutzten Tokens. Die Nutzungsanzeige in der linken Leiste zeigt dieselben Zahlen auf einen Blick, und der Abschnitt **Nutzung** in den Einstellungen bietet eine detaillierte Aufschlüsselung mit Zeiträumen und Modell-Filter.

## Abonnieren

1. Gehe zu **Einstellungen**
2. Öffne den Abschnitt **Abo**
3. Klicke auf **Upgrade**
4. Schliesse den Stripe-Checkout ab (monatlich oder jährlich)
...
Kündige jederzeit über **Manage billing** im Stripe-Portal. Dein Plan bleibt bis zum Ende des aktuellen Abrechnungszeitraums aktiv; offene Nutzung wird mit der letzten Rechnung verrechnet. Danach wechselt dein Konto zurück auf den Free-Plan. Deine Daten (Unterhaltungen, Agenten, Prompts) bleiben erhalten — du verlierst nichts, aber es gelten wieder die Limits des Free-Plans.

## Nutzungsanpassungen

In einigen Fällen kann Magus im Rahmen einer Aktion oder Support-Vereinbarung zusätzliche Kontingente gewähren. Diese Anpassungen werden in deinem Abschnitt **Abo** angezeigt, sofern sie aktiv sind, und können ein Ablaufdatum haben.
